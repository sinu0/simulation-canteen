...
public class StatPanel extends JPanel
{
  ...
  public void setStat()
  {
    ...
    JLabel prvClient = new JLabel("Ilo�� klient�w uprzywilejowanych: " + ClientGenerator.privilageClientGenerate);
    prvClient.setBounds(40, 100, 280, 20);
    add(prvClient);
    statList.add(" Ilo�� klient�w uprzywilejowanych: " + ClientGenerator.privilageClientGenerate);
    
    JLabel groups = new JLabel("Ilo�� grup: " + ClientGenerator.groupClientGenerate);
    groups.setBounds(40, 120, 150, 20);
    add(groups);
    statList.add(" Ilo�� grup: " + ClientGenerator.groupClientGenerate);
    
    JLabel avgGroupSize = new JLabel("�redni rozmiar grupy: " + model.getGroups().getMean());
    avgGroupSize.setBounds(40, 140, 230, 20);
    add(avgGroupSize);
    statList.add(" �redni rozmiar grupy: " + model.getGroups().getMean());
    
    JLabel clientStayed = new JLabel("Zosta�o w sto��wce: " + model.getClientStayedValue());
    clientStayed.setBounds(40, 170, 190, 20);
    add(clientStayed);
    statList.add(" Zosta�o w sto��wce: " + model.getClientStayedValue());
    ...
    JLabel clientLeftBecOfQueue = new JLabel("Odesz�o przez zbyt d�ug� kolejk� do kasy: " + model.getClientLeftBecOfQueue().getValue());
    clientLeftBecOfQueue.setBounds(40, 210, 320, 20);
    add(clientLeftBecOfQueue);
    statList.add(" Odesz�o przez zbyt d�ug� kolejk� do kasy: " + model.getClientLeftBecOfQueue().getValue());
    
    JLabel clientLeftBecOfNoFood = new JLabel("Odesz�o przez brak oczekiwanych da�: " + model.getClientLeftBecOfNoFood().getValue());
    clientLeftBecOfNoFood.setBounds(40, 230, 250, 20);
    add(clientLeftBecOfNoFood);
    statList.add(" Odesz�o przez brak oczekiwanych da�: " + model.getClientLeftBecOfNoFood().getValue());
    ...
    JLabel meanServiceTime = new JLabel("�redni: " + setMinSec(model.getServiceTimeStat().getMean()));
    meanServiceTime.setBounds(40, 350, 120, 20);
    add(meanServiceTime);
    statList.add(" �redni: " + setMinSec(model.getServiceTimeStat().getMean()));
    ...
    JLabel meanMealPrepare = new JLabel("�redni: " + setMinSec(model.getMealPrepareTimeStat().getMean()));
    meanMealPrepare.setBounds(40, 470, 180, 20);
    add(meanMealPrepare);
    statList.add(" �redni: " + setMinSec(model.getMealPrepareTimeStat().getMean()));
    ...
    JLabel eatTime = new JLabel("Czas jedzenia posi�ku");
    ...
    JLabel meanEatTime = new JLabel("�redni: " + setMinSec(model.getMealEatTimeStat().getMean()));
    meanEatTime.setBounds(40, 590, 180, 20);
    add(meanEatTime);
    statList.add(" �redni: " + setMinSec(model.getMealEatTimeStat().getMean()));
    ...
    //kolejka do kasy
    JLabel queueToCashier = new JLabel("Kolejka klient�w do kasy");
    queueToCashier.setBounds(400, 40, 190, 20);
    add(queueToCashier);
    statList.add("Kolejka klient�w do kasy");
    ...
    JLabel meanQueueToCashier = new JLabel("�rednia " + model.getQueueToCashier().getMean());
    meanQueueToCashier.setBounds(410, 80, 250, 20);
    add(meanQueueToCashier);
    statList.add(" �rednia " + model.getQueueToCashier().getMean());
    ...
    //kolejka po miejsce
    JLabel queueForPlace = new JLabel("Kolejka klient�w po miejsce przy stoliku");
    queueForPlace.setBounds(400, 130, 300, 20);
    add(queueForPlace);
    statList.add("Kolejka klient�w po miejsce przy stoliku");
    ...
    JLabel meanQueueForPlace = new JLabel("�rednia: " + model.getQueueForPlace().getMean());
    meanQueueForPlace.setBounds(410, 170, 250, 20);
    add(meanQueueForPlace);
    statList.add(" �rednia: " + model.getQueueForPlace().getMean());
    ...
    JLabel meanIdleCashier = new JLabel(" �rednio: " + mean);
    meanIdleCashier.setBounds(410, 240, 250, 20);
    add(meanIdleCashier);
    statList.add(" �rednio: " + mean);
    ...
    JLabel meanIdleCook = new JLabel(" �rednio: " + model.getIdleCookStat().getMean());
    meanIdleCook.setBounds(410, 310, 250, 20);
    add(meanIdleCook);
    statList.add(" �rednio: " + model.getIdleCookStat().getMean());
